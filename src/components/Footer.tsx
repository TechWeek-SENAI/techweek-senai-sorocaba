      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start gap-3 mb-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Technology Week 2025</p>
              </div>
            </div>
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="flex gap-4">
              <a
                href="https://instagram.com/senaisorocaba"
                target="_blank"
              ...
              <a
                href="mailto:contato@senaisorocaba.edu.br"
                className="w-10 h-10 rounded-full bg-card hover:bg-accent flex items-center justify-center transition-colors group"
                aria-label="Email"
              >
        ...
        <div className="mt-12 pt-8 border-t border-border/50 text-center">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} SENAI Sorocaba. All rights reserved.
          </p>
          <p className="text-xs text-muted-foreground/70 mt-2">
            Developed with ❤️ by ADS students – SENAI Sorocaba
          </p>
        </div>
      </div>
    </footer>
